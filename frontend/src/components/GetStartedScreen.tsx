  ...
  return (
    <div className="pt-6 bg-gradient-to-br from-blue-600 to-blue-300 flex flex-col items-center justify-center p-6 text-white">
      ...
      <div className="w-full flex flex-col items-center text-center">
        ...
        <button
          onClick={handleClick}
          className="w-full bg-white text-blue-600 font-bold text-xl py-5 px-8 rounded-2xl shadow-2xl hover:bg-gray-100 transition-all duration-300 mb-5 flex items-center justify-center gap-3"
        >
          Get Started Now
