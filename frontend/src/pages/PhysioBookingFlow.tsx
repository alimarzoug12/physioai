...
class PhysioBookingFlow extends React.Component<{}, {}> {
  render() {
    return (
      <div className="flex flex-col h-screen bg-gray-50 overflow-y-auto pb-20">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4 relative">
          ...
          {/* Left & Right Icons */}
          <button className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-500 text-2xl">
          ...
          <div className="flex flex-col bg-white gap-3 px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 bg-gray-100 p-2 rounded-xl">
                <button className="text-gray-700 hover:text-gray-900 flex items-center gap-1 bg-white py-1 px-4 rounded-lg">
                  <span className="text-xl"><IconWrapper icon={FaList} /></span> List
                </button>
                <button className="text-gray-700 hover:text-gray-900 flex items-center gap-1 pr-3 pl-1">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center mb-6 mt-2 text-lg">
                    ...
                    <div className="flex gap-4 ml-auto">
                      ...
                      <button className="bg-gradient-to-r from-blue-500 to-white text-white px-6 py-3 rounded-xl font-medium hover:bg-blue-700 shadow-[0_0_20px_rgba(0,0,0,0.1)] shadow-blue-200 transition">
                        Book Now
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center mb-6 mt-2 text-lg">
                    ...
                    <div className="flex gap-3 ml-auto">
                      ...
                      <button className="bg-blue-500 text-white px-4 py-2 rounded-xl font-normal text-xl hover:bg-blue-700 transition">
                        Book
                      </button>
                    </div>
                  </div>
